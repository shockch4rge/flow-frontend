...
import {
    Accordion, AccordionButton, AccordionIcon, AccordionItem, AccordionPanel, Box, Button, Divider,
    Flex, Icon, IconButton, Text, useDisclosure, VStack
                        ...
                        <AccordionItem borderRadius="lg" borderWidth="0px" borderBlockEnd="0px">
                            <h2>
                                <AccordionButton
                                    ...
                                    textColor={
                                        location.pathname === AppRoutes.Board ? "black" : "white"
                                    }
                                    bgColor={
                                        location.pathname === AppRoutes.Board
                                            ? "green.300"
